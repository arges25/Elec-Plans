...
export const TOOL_DEFS: ToolDef[] = [
  {
    id: 'select',
    label: 'Sélection',
    icon: <MousePointer2 className={I} aria-hidden />,
    hint: 'Touchez un élément pour le sélectionner, glissez pour le déplacer.',
    group: 'base',
  },
  { id: 'connect', label: 'Relier', icon: <Cable className={I} aria-hidden />, hint: 'Touchez la commande puis les éléments à relier.', group: 'base' },
  {
    id: 'wall',
    label: 'Mur',
    icon: <BrickWall className={I} aria-hidden />,
    hint: 'Touchez pour poser chaque angle du mur. Double toucher pour terminer.',
    group: 'plan',
  },
  ...
  { id: 'window', label: 'Fenêtre', icon: <AppWindow className={I} aria-hidden />, hint: 'Touchez un mur pour ajouter une fenêtre.', group: 'plan' },
  {
    id: 'room',
    label: 'Pièce',
    icon: <SquareDashed className={I} aria-hidden />,
    hint: 'Glissez pour tracer une pièce rectangulaire, ou touchez pour nommer une pièce.',
    group: 'plan',
  },
  ...
  { id: 'measure', label: 'Mesure', icon: <Ruler className={I} aria-hidden />, hint: 'Touchez le point A puis le point B.', group: 'measure' },
  {
    id: 'scale',
    label: 'Échelle',
    icon: <DraftingCompass className={I} aria-hidden />,
    hint: 'Touchez A puis B, puis saisissez la longueur réelle.',
    group: 'measure',
  },
];
